...
import { App, BullMQConfig, MinioConfig, MongoConfig, RedisConfig } from '@/configs/config-yml/config.model';
  ...
  get app() {
    ...
    return Object.freeze<App>({
      ...
      realm: {
        ...
        namespacePostfix: this.configService.get<string>('App.NAMESPACE_POSTFIX'),
