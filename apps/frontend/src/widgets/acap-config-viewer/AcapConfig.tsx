...
export function AcapConfigViewer() {
  const { isLoading, data, error } = useSWR(
    ["http://localhost:3001/api/v1/metae/acap"],
    get,
  );
      ...
      <div className={style.acapConfig}>
        ...
        >
          <AcapConfigItem label="Redis">
            <SiRedis
              size={"1.2rem"}
              color={getColor(data?.databases.redis, "yellowgreen", "crimson")}
            />
          </AcapConfigItem>
          <AcapConfigItem label="MongoDB">
            <SiMongodb
              size={"1.2rem"}
              color={getColor(data?.databases.mongo, "yellowgreen", "crimson")}
            />
          </AcapConfigItem>
          <AcapConfigItem label="Minio">
            <SiMinio
              size={"1.2rem"}
              color={getColor(data?.databases.minio, "yellowgreen", "crimson")}
            />
          </AcapConfigItem>
        </AcapConfigContainer>
        ...
        >
          <AcapConfigItem label="MQTT">
            <SiMqtt
              size={"1.2rem"}
              color={getColor(data.brokers.mqtt, "yellowgreen", "crimson")}
            />
          </AcapConfigItem>
          <AcapConfigItem label="bullMQ">
            <SiSecurityscorecard
              size={"1.2rem"}
              color={getColor(data.brokers.bullMQ, "yellowgreen", "crimson")}
            />
          </AcapConfigItem>
        ...
        >
          <AcapConfigItem label="Swagger">
            <SiSwagger
              size={"1.2rem"}
              color={getColor(data.services.swagger, "yellowgreen", "crimson")}
            />
          </AcapConfigItem>
          <AcapConfigItem label="Crypto">
            <SiSecurityscorecard
              size={"1.2rem"}
              color={getColor(data.services.crypto, "yellowgreen", "crimson")}
            />
          </AcapConfigItem>
          <AcapConfigItem label="GZIP">
            <FaCompress
              size={"1.2rem"}
              color={getColor(data.services.gzip, "yellowgreen", "crimson")}
            />
          </AcapConfigItem>
